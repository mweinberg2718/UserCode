...
process.susyNtuplizer.outputFileName = cms.string("OUTFILE")
...
if realData:
    ...
    process.source.fileNames = cms.untracked.vstring(
        "INFILE"
        #        "file:/uscms/home/jhirsch/CMSSW_5_2_6/test/stopwinoLQD221_M200.root"
        #"dcap:///pnfs/cms/WAX/11/store/user/lpcsusystealth/stop_RPV_AOD/stopwinoLQD221_M200/stopwinoLQD221_M200_1_1_ZzM.root"
